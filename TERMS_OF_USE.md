...
By using Voice, you agree to the following responsibilities:

### 1. Respect Intellectual Property and Privacy Rights

- Ensure that any audio or material processed through Voice is either owned by you or used with explicit permission from the rightful owner.
...
- Do not use Voice to create or distribute content that harms, defames, or infringes upon the rights of others.
...
Voice and its contributors disclaim all liability for any misuse or unintended consequences arising from the use of this tool.

- **No Warranty**: Voice is provided "as is" without any warranty, express or implied.
- **User Responsibility**: You bear full responsibility for how you choose to use Voice and any outcomes resulting from that use.
- **No Endorsement**: Voice does not endorse or support any activities or content created with this tool that result in harm, illegal activity, or unethical practices.
...
Voice reserves the right to modify these terms at any time. Continued use of the tool signifies your acceptance of any updated terms.
